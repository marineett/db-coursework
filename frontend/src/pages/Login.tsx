...
const Login: React.FC = () => {
  ...
  // Пример использования user_id при загрузке страницы
  useEffect(() => {
    const userId = localStorage.getItem('user_id');
    if (userId) {
      console.log('user_id from localStorage:', userId);
      // Здесь можно сделать автоматический переход или запрос данных пользователя
    }
  }, []);
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      // Сохраняем user_id и repetitor_id
